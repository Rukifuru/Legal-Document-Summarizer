...
MODEL_NAME = "RudreshDutta/legal-summarizer"  # fine-tuned model on Hugging Face Hub
MAX_INPUT_LEN = 512
MAX_TARGET_LEN = 128
...
def load_model():
    ...
    source = f"{MODEL_NAME} (fine-tuned on HF Hub)"
    model.eval()
...
if document_text.strip():
    ...
    st.info("Choose an input mode above to begin.")
